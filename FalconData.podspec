#
# Be sure to run `pod lib lint FalconData.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'FalconData'
  s.version          = '0.1.0'
  s.summary          = 'CoreData awesome wrapper written in Swift'
...
Thanks to SugarRecord you'll be able to use CoreData with just a few lines of code: Just choose your stack and start playing with your data.
  ...
  s.source_files = 'FalconData/Classes/**/*'
  
  # s.resource_bundles = {
  #   'FalconData' => ['FalconData/Assets/*.png']
  # }
